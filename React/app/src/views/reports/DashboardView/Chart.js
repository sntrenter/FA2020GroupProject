...
export default class Chart extends React.Component {
    ...
    async componentDidMount() {
        ...
        console.log(data)
        var width = document.getElementById('temptemp').offsetWidth;//includes margin,border,padding
        var height = document.getElementById('temptemp'). offsetHeight;//includes margin,border,padding
        this.setState({height: height,err: false});
        this.setState({width: width,err: false});
                ...
                {this.state.err || !this.state.activity_log ? (
                    ...
                    <div>Loading...</div>
                        ...
                        <div>
                            ...
                            <LineChart width={this.state.width} height={this.state.height} data={this.state.testdata}>
